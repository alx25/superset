...
class ChartDataExtrasSchema(Schema):
    ...
    column_display_names = fields.Dict(
        keys=fields.String(),
        values=fields.String(),
        metadata={
            "description": "Custom display names for columns to be used in CSV/Excel exports. "
            "Maps column names to their display names."
        },
        allow_none=True,
    )
    excluded_columns = fields.List(
        fields.String(),
        metadata={
            "description": "List of column names that should be excluded from CSV/Excel exports. "
            "Typically includes auxiliary columns like jinja fields and top N metrics."
        },
        allow_none=True,
    )
    calculated_columns_export = fields.List(
        ...
        metadata={
            "description": "Calculated table columns that should be computed during CSV/Excel export. "
            "Each item should contain a label and expression."
        },
        allow_none=True,
    )
    column_export_order = fields.List(
        fields.String(),
        metadata={
            "description": "Preferred export column order for CSV/Excel downloads."
        },
        allow_none=True,
    )
