...
class ChartDataExtrasSchema(Schema):
    ...
    column_display_names = fields.Dict(
        ...
        metadata={
            "description": "Custom display names for columns used in CSV/Excel exports. "
    ...
    excluded_columns = fields.List(
        fields.String(),
        metadata={
            "description": "Column names excluded from CSV/Excel exports (e.g. jinja fields)."
        },
        allow_none=True,
    )
    calculated_columns_export = fields.List(
        ...
        metadata={
            "description": "Calculated columns computed during CSV/Excel export."
        },
        allow_none=True,
    )
    column_export_order = fields.List(
        fields.String(),
        metadata={
            "description": "Preferred column order for CSV/Excel exports."
        },
        allow_none=True,
    )
