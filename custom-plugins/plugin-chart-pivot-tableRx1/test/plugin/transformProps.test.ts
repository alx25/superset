...
describe('PivotTableChart transformProps', () => {
  ...
  it('should preserve disabled enriched cell tooltip', () => {
    const props = new ChartProps<QueryFormData>({
      ...chartProps,
      formData: {
        ...formData,
    ...
    expect(transformProps(props)).toMatchObject({
      showCellTooltip: false,
    });
  });

  it('should preserve enabled sticky headers', () => {
    const props = new ChartProps<QueryFormData>({
      ...chartProps,
      formData: {
        ...formData,
